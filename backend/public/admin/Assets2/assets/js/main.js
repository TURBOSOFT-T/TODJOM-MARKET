...
$(".dark-mode").click(function () {
	$("html").attr("data-bs-theme" , function(i, v){
	  return v === 'semi-dark' ? 'light1' : 'semi-dark';
	})
}) */
...
// Charger et appliquer le thème depuis localStorage au démarrage
$(document).ready(function () {
    const savedTheme = localStorage.getItem("theme") || "light"; // Thème par défaut : "light"
    applyTheme(savedTheme);
});

// Gestion des clics pour changer le thème
$("#LightTheme").on("click", function () {
    applyTheme("light");
});
