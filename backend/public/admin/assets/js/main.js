...
$("#LightTheme").on("click", () => switchTheme("light"));
$("#DarkTheme").on("click", () => switchTheme("dark"));
$("#SemiDarkTheme").on("click", () => switchTheme("semi-dark"));
$("#MinimalTheme").on("click", () => switchTheme("minimal-theme"));
$("#ShadowTheme").on("click", () => switchTheme("shadow-theme"));
