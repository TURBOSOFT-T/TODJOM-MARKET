...
use App\Http\Controllers\Front\{
    ...
    ContactController ,
    TestimonialController as TestimonialFronttController,
   // TestimonialBactController as TestimonialFronttController,
    CouponController as CouponFrontController,
    HomeController,
    MyAccountController,
    CommandeController,
};
...
// Route pour définir le thème dans la session
Route::post('/set-theme', function (Illuminate\Http\Request $request) {
    Session::put('theme', $request->theme); // Stocker le thème en session
    return response()->json(['status' => 'success']);
});

// Route pour récupérer le thème depuis la session
Route::get('/get-theme', function () {
    return response()->json(Session::get('theme', 'light')); // Retourner 'light' si aucun thème n'est défini
});
...
/////temoignages
Route::resource('testimonial', TestimonialFronttController::class);
...
/////Code promo
    Route::post('/savecoupon', [CouponFrontController::class, 'savecoupon'])->name('savecoupon');
    Route::post('/apply-coupon', [CouponFrontController::class, 'applyCoupon'])->name('apply.coupon');
...
Route::middleware(['auth'])->group(function () {
 ...
 Route::get('/admin/transport/add', [AdminController::class, 'transport_add']);
    ...
    Route::resource('/coupons', CouponController::class);
       ...
       Route::resource('testimonials', TestimonialBackController::class);
       Route::get('temoignages/{id}/disapprove', [TestimonialBackController::class, 'disapprove'])->name('temoignages.disapprove');
       Route::get('temoignages/{id}/approve', [TestimonialBackController::class, 'approve'])->name('temoignages.approve');
   ...
   // Route::resource('/coupon', CouponController::class);
    ...
    Route::post('/addVehicule/addVehicule', [BackEventController::class, 'addVehicule'])->name('addVehicule.addVehicule');
