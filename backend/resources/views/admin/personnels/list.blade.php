 ...
 <tbody>
                                @forelse ($personnels as $personnel)
                                    <tr>
                                        ...
                                        <td class="cusor">
                                            {{ $personnel->solde ?? 0 }} <x-devise></x-devise>
                                        </td>

                                        <td class="cusor">
                                            {{ $personnel->points }}<x-devise></x-devise>
                                        ...
                                        <td style="text-align: right;">
                                            ...
                                            <div class="btn-group">
                                                <button class="btn btn-secondary btn-sm" data-bs-toggle="modal"
                                                    data-bs-target="#roleModal{{ $personnel->id }}">
                                                    Modifier rôle
                                                </button>
                                                <button type="button" class="btn btn-sm btn-primary" data-bs-toggle="modal"
                                                    data-bs-target="#personnel-{{ $personnel->id }}">
                                            ...
                                            <button class="btn btn-sm btn-success d-none" type="button"
                                                id="confirmBtn{{ $personnel->id }}"
                                                onclick="url('/admin/personnel/delete/{{ $personnel->id }}')">
                                            ...
                                            @include('admin.personnels.modal-permissions', [
                                                'personnel' => $personnel,
                                            ])
