...
class AddProduit extends Component
{
    ...
    public $nom,$tags, $points,$prix, $category_id,$photo, $photos, $prix_achat, $photo2, $photos2, $produit, $reference, $description,$marque_id ;
...
public $free_shipping;
    ...
    public function update_produit()
    {
        if ($this->produit) {
           ...
           $this->produit->points = $this->points;
